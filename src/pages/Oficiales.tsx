...
// Si prefieres tus estilos antiguos, puedes mantener clases propias;
// aquí uso Bootstrap para que no dependas de rutas.css.
    ...
    <div className="main-content container py-4">
      <div className="text-center mb-4">
        ...
        <h2 className="h5 text-secondary">
          Explora las rutas oficiales de Chile
        </h2>
      </div>
